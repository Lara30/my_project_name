<?php
//src/NH/PlatformBundle/Entity/AdvertRepository.php
...
class AdvertRepository extends EntityRepository
{
    public function getAdverts($page, $nbPerPage)
    {
        ...
        ->setFirstResult(($page-1) * $nbPerPage)
            //ainsi que le nbre d'annonces à afficher s/une page
        ->setMaxResults($nbPerPage)
            ;
        //on retourne l'objet Paginator correspondant à la requête constuite
